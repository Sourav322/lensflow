...
// GET /api/shop
shopRouter.get('/', async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
// PUT /api/shop
shopRouter.put('/', authorize('admin'), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
// GET /api/shop/users
shopRouter.get('/users', authorize('admin'), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
// POST /api/shop/users
shopRouter.post('/users', authorize('admin'), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
shopRouter.patch('/users/:id', authorize('admin'), async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
